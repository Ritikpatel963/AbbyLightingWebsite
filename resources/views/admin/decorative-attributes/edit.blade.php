                                ...
                                <td>
                                    ...
                                    @if($isColor)
                                        <div class="input-group input-group-sm">
                                            <input type="color" class="form-control form-control-sm p-1" style="max-width: 40px; cursor: pointer;" onchange="this.nextElementSibling.value = this.value" value="{{ $val->hex_code ?? '#ffffff' }}">
                                            <input type="text" name="values[{{ $index }}][hex_code]" class="form-control form-control-sm" placeholder="#ffffff" value="{{ $val->hex_code }}">
                                        </div>
                                    @else
