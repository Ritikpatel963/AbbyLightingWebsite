                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%" class="text-center">Image Path</th>
                                        <th width="25%" class="text-center">For Mobile</th>
                                        <th width="25%" class="text-center">Sort Order</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="data module-list" id="data-{{ $row->id }}">
                                        ...
                                        <td class="img-td">
                                            <div class="">
                                                <img style="text-align:center;width:80px;height:60px;object-fit:contain;" src="/storage/{{ $row->path }}" class="list-image-prof">
                                            </div>
                                        </td>
                                        <td>{{@$row->path}}</td>
                                        <td>{{@$row->for_mobile}}</td>
